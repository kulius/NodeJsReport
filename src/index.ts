...
// Middleware
// Chrome Private Network Access: HTTPS public sites fetching this local (private)
// service must receive `Access-Control-Allow-Private-Network: true` on the preflight.
// Must run BEFORE cors() because cors() ends the OPTIONS response itself.
