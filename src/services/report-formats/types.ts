...
import type { LineEntry } from '../escp.service';
...
/** ESC/P LineEntry 產生函式：接收原始資料，回傳 LineEntry[]（供預覽用） */
export type EscpLinesFn = (data: Record<string, unknown>) => LineEntry[];
...
export interface ReportFormatInfo {
  ...
  /** ESC/P LineEntry 產生函式（供預覽用） */
  readonly escpLines?: EscpLinesFn;
